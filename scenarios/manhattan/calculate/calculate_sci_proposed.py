...
l1, l2 = "ETSI dynamic", "Proposed"
# l1, l2 = "No Congestion Control", "Packet Dropping (3GPP)"

fig, ax = plt.subplots()
ax.plot(pers1["distance"], pers1["all"], label=l1)
ax.plot(pers2["distance"], pers2["all"], label=l2)
# ax.plot(pers3["distance"], pers3["all"], label=l3)
...
plt.grid()
plt.savefig(args[1] + "_PER_SCI_proposed.png", dpi=300)

# plt.show()
plt.close(fig)

fig, ax = plt.subplots()
ax.plot(pers1["distance"], pers1["halfDuplex"], label=l1)
ax.plot(pers2["distance"], pers2["halfDuplex"], label=l2)
# ax.plot(pers3["distance"], pers3["halfDuplex"], label=l3)
...
plt.yticks(np.arange(0, 1.1, step=0.1))
plt.grid()
plt.savefig(args[1] + "_PER_SCI_halfDuplex_proposed.png", dpi=300)
# plt.show()
plt.close(fig)

fig, ax = plt.subplots()
ax.plot(pers1["distance"], pers1["prop"], label=l1)
ax.plot(pers2["distance"], pers2["prop"], label=l2)
# ax.plot(pers3["distance"], pers3["prop"], label=l3)
...
plt.yticks(np.arange(0, 1.1, step=0.1))
plt.grid()
plt.savefig(args[1] + "_PER_SCI_propagation_proposed.png", dpi=300)
# plt.show()
plt.close(fig)

fig, ax = plt.subplots()
ax.plot(pers1["distance"], pers1["interference"], label=l1)
ax.plot(pers2["distance"], pers2["interference"], label=l2)
# ax.plot(pers3["distance"], pers3["interference"], label=l3)
...
plt.yticks(np.arange(0, 1.1, step=0.1))
plt.grid()
plt.savefig(args[1] + "_PER_SCI_interference_proposed.png", dpi=300)
# plt.show()
plt.close(fig)

fig, ax = plt.subplots()
ax.plot(pers1["distance"], pers1["sciUnsensed"], label=l1)
ax.plot(pers2["distance"], pers2["sciUnsensed"], label=l2)
# ax.plot(pers3["distance"], pers3["sciUnsensed"], label=l3)
...
plt.yticks(np.arange(0, 1.1, step=0.1))
plt.grid()
plt.savefig(args[1] + "_PER_SCI_unsensed_proposed.png", dpi=300)
# plt.show()
plt.close(fig)