...
labels = ["ETSI dynamic", "Proposed", "Random"]
...
ax.set(xlabel='Predicted Collision Time [s]', ylabel="Age of Information [s]")
...
plt.savefig(args[1] + "_AOI_collisionTime_proposed.png", dpi=300)
# plt.show()
plt.close(fig)
