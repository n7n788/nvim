...
def calculate_age_of_information():
    ...
    aoi_reletiveVelocity_vector = 'perceptedObjectReletiveVelocity:vector'
    ...
    reletiveVelocities = df[(df["name"] == aoi_reletiveVelocity_vector) & (df["vectime"].notnull())]
    ...
    for row in new_df.itertuples():
        # そのモジュールがcpmを送信した(自動運転車)なら、結果をチェック
