...
plt.grid()
plt.savefig(args[1] + "_PER_SCI_dcc.png", dpi=300)
...
plt.yticks(np.arange(0, 1.1, step=0.1))
plt.grid()
plt.savefig(args[1] + "_PER_SCI_halfDuplex_dcc.png", dpi=300)
# plt.show()
plt.close(fig)
...
plt.yticks(np.arange(0, 1.1, step=0.1))
plt.grid()
plt.savefig(args[1] + "_PER_SCI_propagation_dcc.png", dpi=300)
# plt.show()
plt.close(fig)
...
plt.yticks(np.arange(0, 1.1, step=0.1))
plt.grid()
plt.savefig(args[1] + "_PER_SCI_interference_dcc.png", dpi=300)
# plt.show()
plt.close(fig)
...
plt.yticks(np.arange(0, 1.1, step=0.1))
plt.grid()
plt.savefig(args[1] + "_PER_SCI_unsensed_dcc.png", dpi=300)
# plt.show()
plt.close(fig)