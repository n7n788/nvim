...
plt.savefig(args[1] + args[2] + "_riskCoefficientCnt_pdf.png", dpi=300)
plt.close()
...
plt.title("PDF of risk coefficient", y=-1.0)
plt.savefig(args[1] + args[2] + "_riskCoefficientCnt_limited_pdf.png", dpi=300)
plt.close()
...
plt.savefig(args[1] + args[2] + "_riskCoefficientCnt_cdf.png", dpi=300)
plt.close()
...
plt.savefig(args[1] + args[2] + "_riskCoefficientCnt_over.png", dpi=300)
plt.close()
...
plt.savefig(args[1] + args[2] + "_riskCoefficientCnt_zero.png", dpi=300)
plt.close()
...
plt.savefig(args[1] + args[2] + "_riskCoefficientCnt_accel.png", dpi=300)
plt.close()
...
plt.savefig(args[1] + args[2] + "_riskCoefficientCnt_decel.png", dpi=300)
plt.close()
